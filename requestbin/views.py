...
from flask import session, redirect, url_for, escape, request, render_template, make_response  # noqa: E501,F401
...
def bin(name):
    ...
    if request.query_string == 'inspect':
        ...
        return render_template('bin.html',
                               ...
                               request_expiry=(datetime.utcnow() + timedelta(seconds=db.expiry_time(name))).strftime("%Y/%m/%d, %H:%M:%S"))  # noqa: E128,,E501
    else:
