...
if os.environ.get('ENABLE_CORS', config.ENABLE_CORS):
    cors = CORS(app, resources={r"*": {"origins": os.environ.get('CORS_ORIGINS', config.CORS_ORIGINS)}})  # noqa: E501
...
if config.BUGSNAG_KEY:
    ...
    bugsnag.configure(
        ...
        release_stage = config.REALM.replace("prod", "production"),  # noqa: E251,E501
...
app.add_url_rule('/<path:name>', 'views.bin', methods=['GET', 'POST', 'DELETE', 'PUT', 'OPTIONS', 'HEAD', 'PATCH', 'TRACE'])  # noqa: 501
...
app.add_url_rule('/api/v1/bins/<bin>/requests', 'api.requests', methods=['GET'])  # noqa: E501
app.add_url_rule('/api/v1/bins/<bin>/requests/<name>', 'api.request', methods=['GET'])  # noqa: E501
